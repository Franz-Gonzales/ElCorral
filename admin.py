...
class login_page:
    def __init__(self, top=None):
        ...
        self.button1.place(relx=0.366, rely=0.680, width=356, height=43)
        self.button1.configure(relief="flat")
        self.button1.configure(overrelief="flat")
        self.button1.configure(activebackground="#185494")
        self.button1.configure(cursor="hand2")
        self.button1.configure(foreground="#ffffff")
        self.button1.configure(background="#185494")
        ...
        self.button2.configure(activebackground="#185494")
        self.button2.configure(cursor="hand2")
        self.button2.configure(foreground="#ffffff")
        self.button2.configure(background="#185494")
...
class Admin_Page:
    def __init__(self, top=None):
        ...
        self.message.place(relx=0.046, rely=0.056, width=68, height=30)
        ...
        self.button1.configure(relief="flat")
        self.button1.configure(overrelief="flat")
        self.button1.configure(activebackground="#f4382d")
        self.button1.configure(cursor="hand2")
        self.button1.configure(foreground="#ffffff")
        self.button1.configure(background="#f4382d")
...
class Inventory:
    def __init__(self, top=None):
        ...
        self.message.place(relx=0.120, rely=0.090, width=136, height=30)
        ...
        self.clock.place(relx=0.82, rely=0.065, width=155, height=36)
        ...
        self.button2.place(relx=0.035, rely=0.090, width=76, height=23)
        self.button2.configure(relief="flat")
        self.button2.configure(overrelief="flat")
        self.button2.configure(activebackground="#185494")
        self.button2.configure(cursor="hand2")
        ...
        self.button3.configure(relief="flat")
        self.button3.configure(overrelief="flat")
        self.button3.configure(activebackground="#185494")
        self.button3.configure(cursor="hand2")
        self.button3.configure(foreground="#ffffff")
        self.button3.configure(background="#185494")
        self.button3.configure(font="-family {Poppins SemiBold} -size 12")
        self.button3.configure(borderwidth="0")
        ...
        self.button4.configure(relief="flat")
        self.button4.configure(overrelief="flat")
        self.button4.configure(activebackground="#185494")
        self.button4.configure(cursor="hand2")
        self.button4.configure(foreground="#ffffff")
        self.button4.configure(background="#185494")
        self.button4.configure(font="-family {Poppins SemiBold} -size 12")
        self.button4.configure(borderwidth="0")
        ...
        self.button5.configure(activebackground="#185494")
        self.button5.configure(cursor="hand2")
        self.button5.configure(foreground="#ffffff")
        self.button5.configure(background="#185494")
        ...
        self.button6.configure(activebackground="#f4382d")
        self.button6.configure(cursor="hand2")
        self.button6.configure(foreground="#ffffff")
        self.button6.configure(background="#f4382d")
...
class add_product:
    def __init__(self, top=None):
        ...
        self.clock.place(relx=0.84, rely=0.065, width=155, height=36)
        self.clock.configure(font="-family {Poppins Light} -size 12")
        self.clock.configure(foreground="#000000")
        self.clock.configure(background="#ffffff")
        ...
        self.button2.configure(relief="flat")
        self.button2.configure(overrelief="flat")
        self.button2.configure(activebackground="#FFE497")
        self.button2.configure(cursor="hand2")
        self.button2.configure(foreground="#ffffff")
        self.button2.configure(background="#FFE497")
...
class Update_Product:
    def __init__(self, top=None):
        ...
        # self.button1.place(relx=0.408, rely=0.836, width=96, height=34)
        self.button1.place(relx=0.360, rely=0.836, width=150, height=34)
        self.button1.configure(relief="flat")
        self.button1.configure(overrelief="flat")
        self.button1.configure(activebackground="#185494")
        self.button1.configure(cursor="hand2")
...
class Employee:
    def __init__(self, top=None):
        ...
        self.button2.place(relx=0.040, rely=0.106, width=125, height=28)
        self.button2.configure(relief="flat")
        self.button2.configure(overrelief="flat")
        self.button2.configure(activebackground="#f4382d")
        self.button2.configure(cursor="hand2")
        self.button2.configure(foreground="#ffffff")
        self.button2.configure(background="#f4382d")
        self.button2.configure(font="-family {Poppins SemiBold} -size 12")
        self.button2.configure(borderwidth="0")
...
class add_employee:
    def __init__(self, top=None):
        ...
        self.button1.place(relx=0.400, rely=0.834, width=110, height=31)
        self.button1.configure(relief="flat")
        self.button1.configure(overrelief="flat")
        self.button1.configure(activebackground="#185494")
        self.button1.configure(cursor="hand2")
        ...
        self.button2.configure(foreground="#ffffff")
        self.button2.configure(background="#FFE497")
        self.button2.configure(font="-family {Poppins SemiBold} -size 13")
        self.button2.configure(borderwidth="0")
        self.button2.configure(text="""LIMPIAR""")
        self.button2.configure(command=self.clearr)
...
class Invoice:
    def __init__(self, top=None):
        ...
        self.message.place(relx=0.130, rely=0.080, width=136, height=30)
        self.message.configure(font="-family {Poppins} -size 10")
        self.message.configure(foreground="#000000")
        self.message.configure(background="#ffffff")
        self.message.configure(text="""ADMIN""")
        ...
        self.button2.place(relx=0.050, rely=0.085, width=76, height=23)
        self.button2.configure(relief="flat")
        self.button2.configure(overrelief="flat")
        self.button2.configure(activebackground="#185494")
        self.button2.configure(cursor="hand2")
        ...
        self.button3.place(relx=0.052, rely=0.435, width=306, height=28)
        self.button3.configure(relief="flat")
        self.button3.configure(overrelief="flat")
        self.button3.configure(activebackground="#185494")
        self.button3.configure(cursor="hand2")
        ...
        self.button4.configure(relief="flat")
        self.button4.configure(overrelief="flat")
        self.button4.configure(activebackground="#f4382d")
        self.button4.configure(cursor="hand2")
        self.button4.configure(foreground="#ffffff")
        self.button4.configure(background="#f4382d")
        self.button4.configure(font="-family {Poppins SemiBold} -size 12")
        self.button4.configure(borderwidth="0")
